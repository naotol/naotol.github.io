...
function changeShowcaseCategory(id) {
    if (id == 0) {
        ...
        document.getElementById("showcaseBox").innerHTML="<div id='mp3playerthingy'><div id='album'><img src='./img/album-export.png' class='album'></div><div id='songdetail'><div>School Days</div><div style='font-size: 30px; padding-top: 10px;'>Otherworldly!: Act I</div><div style='font-size: 30px; padding-top: 10px; padding-bottom: 50px;'>naotol</div><audio src='./audio/school_days.wav' controls></audio></div></div><div id='mp3playerthingy'><div id='album'><img src='./img/album-export.png' class='album'></div><div id='songdetail'><div>Breaktime</div><div style='font-size: 30px; padding-top: 10px;'>Otherworldly!: Act I</div><div style='font-size: 30px; padding-top: 10px; padding-bottom: 50px;'>naotol</div><audio src='./audio/safe_zone.wav' controls></audio></div></div><div id='mp3playerthingy'><div id='album'><img src='./img/album-export.png' class='album'></div><div id='songdetail'><div>Capitalism Owns</div><div style='font-size: 30px; padding-top: 10px;'>Otherworldly!: Act I</div><div style='font-size: 30px; padding-top: 10px; padding-bottom: 50px;'>naotol</div><audio src='./audio/shop.wav' controls></audio></div></div><div id='mp3playerthingy'><div id='album'><img src='./img/album-export.png' class='album'></div><div id='songdetail'><div>Showdown!</div><div style='font-size: 30px; padding-top: 10px;'>Otherworldly!: Act II</div><div style='font-size: 30px; padding-top: 10px; padding-bottom: 50px;'>naotol</div><audio src='./audio/showdown.wav' controls></audio></div></div><div id='mp3playerthingy'><div id='album'><img src='./img/album-export.png' class='album'></div><div id='songdetail'><div>The Cruise</div><div style='font-size: 30px; padding-top: 10px;'>Otherworldly!: Act I</div><div style='font-size: 30px; padding-top: 10px; padding-bottom: 50px;'>naotol</div><audio src='./audio/the_cruise.wav' controls></audio></div></div><div id='mp3playerthingy'><div id='album'><img src='./img/album-export.png' class='album'></div><div id='songdetail'><div>Shantaro Town</div><div style='font-size: 30px; padding-top: 10px;'>Otherworldly!: Act I</div><div style='font-size: 30px; padding-top: 10px; padding-bottom: 50px;'>naotol</div><audio src='./audio/hometown.wav' controls></audio></div></div><div id='mp3playerthingy'><div id='album'><img src='./img/album-export.png' class='album'></div><div id='songdetail'><div>Normal Battle</div><div style='font-size: 30px; padding-top: 10px;'>Otherworldly!: Act I</div><div style='font-size: 30px; padding-top: 10px; padding-bottom: 50px;'>naotol</div><audio src='./audio/norm_battle.wav' controls></audio></div></div>"
    }
    else {
        document.getElementById("showcaseBox").innerHTML="<div style='margin-top: 20px;font-size: 40px'>This website itself and the upcoming \"Otherworldly\" game are the showcase!</div><iframe style='margin-top: 20px' frameborder='0' src='https://itch.io/embed/4603518?bg_color=2d2d2d&amp;fg_color=e5e5e5&amp;link_color=24ff20&amp;border_color=404a50' width='552' height='167'><a href='https://naotol.itch.io/godot4-scrolling-meter'>Godot 4 - Scrolling Meter by naotol</a></iframe>"
    }
}
